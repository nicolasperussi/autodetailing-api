...
public class Seeding implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        jobRepository.saveAll(List.of(s1, s2, s3));
        ...
        BookingJob ji1 = new BookingJob(j1, s1, s1.getCurrentPrice());
        BookingJob ji2 = new BookingJob(j2, s2, s2.getCurrentPrice());
        BookingJob ji3 = new BookingJob(j2, s3, s3.getCurrentPrice());
